                        ...
                        <div className="flex">
                            ...
                            <div className="ml-3">
                                <p className="text-sm text-yellow-700 dark:text-yellow-200">
                                    ...
                                    <br />
                                    Anda belum menambahkan data supplier.
            ...
            >
                ...
                <DialogBody>
                    <p className="text-sm text-zinc-600 dark:text-zinc-300">
                        Yakin ingin menghapus supplier ini? Semua produk yang
                        berasal dari supplier ini akan ditandai sebagai "
                        <b>Tanpa Supplier</b>". Tindakan ini tidak dapat
                        dibatalkan!
                    </p>
                </DialogBody>
                <DialogActions>
