    ...
    return (
        <>
                                ...
                                <table className="min-w-full divide-y divide-gray-300 dark:divide-white/10">
                                    <tbody className="divide-y divide-gray-200 bg-white dark:divide-white/10 dark:bg-zinc-900">
                                        <tr key="1">
                                            ...
                                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-bold text-gray-900 dark:text-white sm:pl-6">
                                                {timeAsText}
                                            </td>
                                        </tr>
                                        <tr key="2">
            ...
            >
                ...
                <DialogBody>
                    <p className="mb-5 text-gray-700 dark:text-zinc-300">
                        Tanggal Hari Ini: {new Date().toLocaleDateString()}
                    </p>
                    <div>
                            ...
                            <div className="flex space-x-4">
                                <div className="w-full">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 block w-full rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-white/10 dark:bg-white/5 dark:text-white dark:[color-scheme:dark] sm:text-sm"
                                    />
                                </div>
                                <div className="w-full">
                                    <label
