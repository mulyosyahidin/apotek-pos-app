        ...
        <>
            ...
            <AdminLayout>
                <div className="flex items-center justify-between">
                    ...
                    <Button href={route('product-groups.create')} className="cursor-pointer">
                        Tambah
                    </Button>
                </div>
                                        ...
                                        return (
                                            <TableRow key={item.id}>
                                                ...
                                                <TableCell className="flex justify-end gap-1">
                                                    <Button
                                                        outline={true}
                                                        href={route('product-groups.edit', item.id)}
                                                        size="small"
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-3">
                                    <p className="text-sm text-yellow-700">
                                        ...
                                        <br/>
                                        Anda belum menambahkan data grup produk. Silahkan tambahkan data dengan klik tombol
            ...
            <Dialog open={isDeleteDialogOpen} onClose={() => setIsDeleteDialogOpen(false)}>
                ...
                <DialogBody>
                    <p>Yakin ingin menghapus grup produk ini? Semua produk dalam grup ini juga akan dihapus. Tindakan
